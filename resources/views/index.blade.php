...
<head>
    ...
    <title>Klinik mooi dental surabaya</title>
    ...
    <div class="min-h-screen ">
        ...
        <div class="flex justify-between relative h-[400px] bg-white rounded-b-[100px] shadow-md md:px-32">
            <div class=" w-2/5">
                ...
                <p class="mt-12">
                Mooi adalah aplikasi Sistem Informasi Manajemen Klinik pada klinik Mooi Dental Klinik yang berlokasi di Surabaya. bertujuan untuk membantu proses 
            ...
            <div class="mt-14 md:mr-36">
                <img src="{{ asset('public/img/mooi.png') }}" style="width: 300px; height:250px;">
            </div>
        </div>
        ...
        <div class="md:flex md:justify-center mx-auto md:px-24 space-x-12 mt-12">
            <div class="md:w-1/2 h-90 block p-9 bg-white rounded-xl border border-gray-200 shadow-xl hover:bg-cyan-500 group">
                ...
                <img src="{{ asset('public/img/logossaao.png') }}" style="width: 200px; height:100px;"  >
                </div>
                <p class="mt-12">
            ...
            <div class="md:w-1/2 h-90 block p-6 bg-white rounded-xl border border-gray-200 shadow-xl hover:bg-cyan-600 group">
                <img src="{{ asset('public/img/info.jpeg') }}" style="width: 350px; height:290px;">
            </div>
            ...
            <div class="md:w-1/2 h-90 block p-6 bg-white rounded-xl border border-gray-200 shadow-xl hover:bg-cyan-600 group">
                ...
                <img src="{{ asset('public/img/dokter.png') }}" style="width: 80%; height:180px;">
                <p class="mt-12">
